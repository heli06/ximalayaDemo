...
export { default as IconDeleteItemCcAndM } from './IconDeleteItemCcAndM';
...
export type IconNames = 'icon-DeleteItemCCAndM' | 'icon-loading' | 'icon-volume-up' | 'icon-favorites-fill' | 'icon-volume-off' | 'icon-pause' | 'icon-play-arrow' | 'icon-fullscreen' | 'icon-lijitingke' | 'icon-bofang3' | 'icon-paste' | 'icon-shangyishou' | 'icon-xiayishou' | 'icon-down' | 'icon-back' | 'icon-huanyipi' | 'icon-xihuan' | 'icon-more' | 'icon-shengyin' | 'icon-V' | 'icon-user' | 'icon-bofang' | 'icon-play2' | 'icon-time' | 'icon-message' | 'icon-bofang1' | 'icon-bofang2' | 'icon-faxian' | 'icon-shijian' | 'icon-shouye' | 'icon-shoucang';
...
let IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    case 'icon-DeleteItemCCAndM':
      return <IconDeleteItemCcAndM key="1" {...rest} />;
    case 'icon-loading':
      return <IconLoading key="2" {...rest} />;
    case 'icon-volume-up':
      return <IconVolumeUp key="3" {...rest} />;
    case 'icon-favorites-fill':
      return <IconFavoritesFill key="4" {...rest} />;
    case 'icon-volume-off':
      return <IconVolumeOff key="5" {...rest} />;
    case 'icon-pause':
      return <IconPause key="6" {...rest} />;
    case 'icon-play-arrow':
      return <IconPlayArrow key="7" {...rest} />;
    case 'icon-fullscreen':
      return <IconFullscreen key="8" {...rest} />;
    case 'icon-lijitingke':
      return <IconLijitingke key="9" {...rest} />;
    case 'icon-bofang3':
      return <IconBofang3 key="10" {...rest} />;
    case 'icon-paste':
      return <IconPaste key="11" {...rest} />;
    case 'icon-shangyishou':
      return <IconShangyishou key="12" {...rest} />;
    case 'icon-xiayishou':
      return <IconXiayishou key="13" {...rest} />;
    case 'icon-down':
      return <IconDown key="14" {...rest} />;
    case 'icon-back':
      return <IconBack key="15" {...rest} />;
    case 'icon-huanyipi':
      return <IconHuanyipi key="16" {...rest} />;
    case 'icon-xihuan':
      return <IconXihuan key="17" {...rest} />;
    case 'icon-more':
      return <IconMore key="18" {...rest} />;
    case 'icon-shengyin':
      return <IconShengyin key="19" {...rest} />;
    case 'icon-V':
      return <IconV key="20" {...rest} />;
    case 'icon-user':
      return <IconUser key="21" {...rest} />;
    case 'icon-bofang':
      return <IconBofang key="22" {...rest} />;
    case 'icon-play2':
      return <IconPlay2 key="23" {...rest} />;
    case 'icon-time':
      return <IconTime key="24" {...rest} />;
    case 'icon-message':
      return <IconMessage key="25" {...rest} />;
    case 'icon-bofang1':
      return <IconBofang1 key="26" {...rest} />;
    case 'icon-bofang2':
      return <IconBofang2 key="27" {...rest} />;
    case 'icon-faxian':
      return <IconFaxian key="28" {...rest} />;
    case 'icon-shijian':
      return <IconShijian key="29" {...rest} />;
    case 'icon-shouye':
      return <IconShouye key="30" {...rest} />;
    case 'icon-shoucang':
      return <IconShoucang key="31" {...rest} />;
  }
